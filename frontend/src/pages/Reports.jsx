    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="card">
          ...
          <p className="text-4xl font-bold text-gray-900">{reportData?.total_runs || 0}</p>
        ...
        <div className="card">
          ...
          <p className="text-4xl font-bold text-gray-900">{reportData?.transfer_dispositions || 0}</p>
